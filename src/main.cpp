...
uint256 hashGenesisBlock("0x8e5ecfe13dcf54b0c0d145dc3886339f6f9af7c8aa05c8eda0f5d974af1632a0");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Cannabiscoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Cannabiscoin Signed Message:\n";
...
{
    // Cannabiscoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Cannabiscoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Cannabiscoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Cannabiscoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x8e5ecfe13dcf54b0c0d145dc3886339f6f9af7c8aa05c8eda0f5d974af1632a0");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1396299833;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2086264036;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("CannabiscoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("CannabiscoinMiner : ProcessBlock, block not accepted");
    }
...
void static LitecoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running Cannabiscoin with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("CannabiscoinMiner terminated\n");
        throw;
    }
}
